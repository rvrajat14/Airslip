...
public class APIClient {
    ...
    public static var `default` = APIClient(baseURL: BankTransactionsApi.Server.main)
    ...
    public init(baseURL: String, sessionManager: Session = .default, defaultHeaders: [String: String] = [:], behaviours: [RequestBehaviour] = []) {
        ...
        jsonEncoder.dateEncodingStrategy = .formatted(BankTransactionsApi.dateEncodingFormatter)
    }
