...
public class NotFoundResponse: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? NotFoundResponse else { return false }
    ...
    public static func == (lhs: NotFoundResponse, rhs: NotFoundResponse) -> Bool {
