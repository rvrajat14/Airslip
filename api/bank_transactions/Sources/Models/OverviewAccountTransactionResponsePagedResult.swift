...
public class OverviewAccountTransactionResponsePagedResult: APIModel {
    ...
    public var results: [OverviewAccountTransactionResponse]?

    public var rowCount: Int?

    public var totalCount: Int?

    public init(currentPage: Int? = nil, pageCount: Int? = nil, pageSize: Int? = nil, results: [OverviewAccountTransactionResponse]? = nil, rowCount: Int? = nil, totalCount: Int? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? OverviewAccountTransactionResponsePagedResult else { return false }
    ...
    public static func == (lhs: OverviewAccountTransactionResponsePagedResult, rhs: OverviewAccountTransactionResponsePagedResult) -> Bool {
