...
extension IdentityApi.UserProfile {
    ...
    public enum GetV1ProfilePhoto {

        public static let service = APIService<Response>(id: "getV1ProfilePhoto", tag: "UserProfile", method: "GET", path: "/v1/profile/photo", hasBody: false, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: GetV1ProfilePhoto.service)
            }
        }
